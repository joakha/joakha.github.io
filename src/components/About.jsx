...
const About = () => {
    return (
        <section id="about" className="my-16 scroll-mt-32">
            <div className="flex flex-col gap-4 items-center text-chocolate-milk font-bold mb-16">
                ...
                <div className="flex gap-4">
                    <a href="https://github.com/joakha"
                        className="text-xl underline underline-offset-4 font-bold text-choco"
                        target="_blank"
                    >
                        GitHub
                    </a>
            ...
            <div className="flex flex-col items-center lg:flex-row lg:justify-center gap-10">
                <div className="h-[300px w-[375px] lg:w-[439px]">
                    <img src={profilePicture} className="rounded-md w-full h-full object-cover object-center" />
                </div>

                <div className="h-[300px] w-[375px] lg:w-[600px] bg-chocolate-light text-white text-justify p-6 overflow-auto rounded">
                    {lorem}
                </div>
            </div>
        </section>
